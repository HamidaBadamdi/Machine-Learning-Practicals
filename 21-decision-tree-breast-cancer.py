"""
21 - Decision Tree Classification (Breast Cancer Dataset)

Description:
This program demonstrates Decision Tree classification using the Breast
Cancer dataset. The model is trained on the training data and evaluated
