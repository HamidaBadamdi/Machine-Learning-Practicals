...
Description:
This program demonstrates how to split a dataset into training and testing
sets using scikit-learn. The Wine dataset is loaded, features and target
labels are separated, and the data is divided for model training and evaluation.
