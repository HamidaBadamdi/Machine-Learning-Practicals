"""
Practical 46: Agglomerative Clustering on Titanic Dataset

Objective:
To implement Agglomerative Hierarchical Clustering on the Titanic dataset
and visualize the resulting clusters using PCA and a dendrogram.
...
4. Apply Agglomerative Clustering with three clusters.
5. Visualize clusters using PCA.
6. Generate a hierarchical clustering dendrogram.

Outcome:
Successfully implemented Agglomerative Clustering and visualized the
hierarchical relationships and generated clusters.
