...
Description:
This program trains a Decision Tree classifier on the Iris dataset and
evaluates its performance using accuracy, confusion matrix, and
classification report after splitting the dataset into training and
testing sets.
