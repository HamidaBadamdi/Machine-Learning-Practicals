"""
34 - Glass Classification using Multinomial Logistic Regression

Description:
This program builds a Multinomial Logistic Regression model to
classify different types of glass. It preprocesses the data,
trains the model, evaluates performance, and predicts the class
of a new glass sample.
