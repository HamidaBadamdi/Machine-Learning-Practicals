...
Description:
This program demonstrates Simple Linear Regression using a CPU Time
and Disk I/O dataset. The model is trained to predict CPU time based
on Disk I/O values, and the regression line is visualized.
...
data=pd.read_csv("datasets/cputime.csv")
