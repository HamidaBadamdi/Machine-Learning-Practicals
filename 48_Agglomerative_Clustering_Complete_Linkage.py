"""
Practical 48: Agglomerative Clustering using Complete Linkage

Objective:
To implement Agglomerative Hierarchical Clustering on the Breast Cancer
dataset using Complete Linkage and evaluate the clustering performance.
...
Outcome:
Successfully implemented Complete Linkage clustering and evaluated the
ge1
nerated clusters using the Silhouette Score.
"""
import numpy as np
