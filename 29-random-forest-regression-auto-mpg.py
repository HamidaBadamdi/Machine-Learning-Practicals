"""
29 - Random Forest Regression for Auto MPG Prediction

Description:
This program implements a Random Forest Regression model to predict
vehicle fuel efficiency (MPG). It preprocesses the dataset by handling
missing values and evaluates the model using MSE and R² score.
